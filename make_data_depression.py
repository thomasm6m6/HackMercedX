...
for i, schedule in enumerate(schedules):
    string = "Generate a response that is indicative of a person who is depressed, to each of the following questions."
...
with open("responses/depression.json", 'w') as f:
    json.dump(data, f)